...
void main( void )
{
  ...
  /*  lightVector= normalize(vec4(lightPosition - vertex, 1.0));
    eyeVector = normalize(eyePosition - vertex);
    vertNormal = normalize(normalMatrix * normal);*/

    lightVector= vec4(lightPosition - vertex, 1.0);
    eyeVector = eyePosition - vertex;
